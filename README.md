...
```bash
curl -sSfL https://raw.githubusercontent.com/khulnasoft-lab/gobin/main/install.sh | sh -s -- -b /usr/local/bin
```

... or, you can specify a release version and destination directory for the installation:

```bash
curl -sSfL https://raw.githubusercontent.com/khulnasoft-lab/gobin/main/install.sh | sh -s -- -b <DESTINATION_DIR> <RELEASE_VERSION>
```
