...
func Test_templateFlags(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want:    "-X github.com/khulnasoft-lab/gobin/internal/version.Version=1.2.3",
			wantErr: assert.NoError,
		},
		{
			...
			args: args{
				ldFlags: []string{
					"-X github.com/khulnasoft-lab/gobin/internal/something.Else=hardcoded",
				},
				version: "1.2.3",
			},
			want:    "-X github.com/khulnasoft-lab/gobin/internal/something.Else=hardcoded",
			wantErr: assert.NoError,
		},
	}
